...
/// We've received a message. If it was not sent by the bot themself forward the [EventId][matrix_sdk::ruma::EventId] to potentially confirm the federation of a message.
...
pub async fn handle_template_state_event(
    ...
    tx_renderer
        .send(AlertRendererChannelMessage::RegisterTemplate {
            room_id,
            event_id,
            plain,
            html,
